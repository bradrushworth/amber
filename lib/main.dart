                  ...
                  children: [
                    ...
                    Expanded(
                      child: GridView.count(
                        ...
                        mainAxisSpacing: 16,
                        children: [
                          MyCard(child: BarChartWidget1('Electricity Use - Last 24 Hours', const Duration(days: 1))),
                          MyCard(child: BarChartWidget1('Electricity Use - Last 2 Days Averaged', const Duration(days: 2))),
                          MyCard(child: BarChartWidget1('Electricity Use - Last 7 Days Averaged', const Duration(days: 7))),
                          MyCard(child: BarChartWidget1('Electricity Use - Last 21 Days Averaged', const Duration(days: 21))),
