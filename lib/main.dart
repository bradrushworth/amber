                    ...
                    Expanded(
                      child: GridView.count(
                        ...
                        children: [
                          ...
                          MyCard(child: BarChartWidget1('Electricity Use - Last 3 Days Averaged', const Duration(days: 3), prices: false)),
                          MyCard(child: BarChartWidget1('Electricity Cost - Last 3 Days Averaged', const Duration(days: 3), prices: true)),
                          MyCard(child: BarChartWidget1('Electricity Use - Last 7 Days Averaged', const Duration(days: 7), prices: false)),
                          MyCard(child: BarChartWidget1('Electricity Cost - Last 7 Days Averaged', const Duration(days: 7), prices: true)),
                          MyCard(child: BarChartWidget1('Electricity Use - Last 21 Days Averaged', const Duration(days: 21), prices: false)),
                          MyCard(child: BarChartWidget1('Electricity Cost - Last 21 Days Averaged', const Duration(days: 21), prices: true)),
